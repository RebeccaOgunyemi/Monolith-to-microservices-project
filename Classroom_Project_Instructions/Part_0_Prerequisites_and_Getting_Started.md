...
Assuming the endpoint is: `olufunmilayosmiles.cszk6jbmnhil.us-east-1.rds.amazonaws.com`, you can run:
```bash  
psql -h molufunmilayosmiles.cszk6jbmnhil.us-east-1.rds.amazonaws.com -U [your-username] postgres
...
setx POSTGRES_HOST olufunmilayosmiles.cszk6jbmnhil.us-east-1.rds.amazonaws.com
setx POSTGRES_DB postgres
setx AWS_BUCKET olufunmilayosmiles
